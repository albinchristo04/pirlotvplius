...
// --- Hub Pages ---
const HUB_PAGES = [
    { slug: 'tarjeta-roja', title: '🔴 Tarjeta Roja — Ver Fútbol EN VIVO GRATIS | Velcuri', desc: 'Para ver fútbol gratis en lugar de Tarjeta Roja, entra a Velcuri y elige tu partido. Todos los partidos de hoy en directo, sin registro, sin suscripción.', keyword: 'Tarjeta Roja', links: ['/rojadirecta/', '/pirlotv/', '/partidos-de-hoy/'] },
    { slug: 'rojadirecta', title: '▶ Rojadirecta EN VIVO — Partidos Gratis Hoy | Velcuri', desc: 'Alternativa a Rojadirecta para ver fútbol en vivo gratis hoy. Champions League, LaLiga, Premier League en directo sin pagar.', keyword: 'Rojadirecta', links: ['/tarjeta-roja/', '/pirlotv/', '/partidos-en-vivo/'] },
    { slug: 'pirlotv', title: '📺 Pirlo TV EN VIVO — Fútbol Gratis Online | Velcuri', desc: 'Ver fútbol como en Pirlotv pero sin cortes. Todos los partidos en vivo gratis, múltiples canales, sin instalar nada.', keyword: 'Pirlotv', links: ['/rojadirecta/', '/tarjeta-roja/'] },
    { slug: 'partidos-de-hoy', title: `🗓️ Partidos de Hoy ${formatDate(BUILD_DATE)} EN VIVO Gratis | Velcuri`, desc: `Partidos de fútbol de hoy ${formatDate(BUILD_DATE)} en vivo gratis. Encuentros disponibles ahora mismo en directo.`, keyword: 'Partidos de Hoy', links: ['/partidos-en-vivo/', '/futbol-en-vivo/'] },
    { slug: 'partidos-en-vivo', title: '🔴 Partidos EN VIVO Ahora Mismo GRATIS | Velcuri', desc: 'Partidos de fútbol en vivo ahora mismo. Transmisiones en directo gratis sin registro.', keyword: 'Partidos en Vivo', links: ['/partidos-de-hoy/', '/futbol-en-vivo/'] },
    ...
    { slug: 'futbol-gratis', title: '📺 Ver Fútbol GRATIS Online | Sin Registro — Velcuri', desc: 'Ver fútbol gratis online sin registro ni suscripción. Partidos en vivo de todas las ligas.', keyword: 'Fútbol Gratis', links: ['/futbol-en-vivo/', '/partidos-de-hoy/'] },
    { slug: 'ver-futbol-online', title: '▶ Ver Fútbol Online EN VIVO | HD Gratis — Velcuri', desc: 'Ver fútbol online en vivo en HD gratis. Sin cortes, sin registro, sin suscripción.', keyword: 'Ver Fútbol Online', links: ['/futbol-en-vivo/', '/pirlotv/'] },
    { slug: 'futbol-para-todos', title: '🔴 Fútbol Para Todos EN VIVO GRATIS | Velcuri', desc: 'Fútbol para todos en vivo y gratis. Todos los partidos de hoy en directo.', keyword: 'Fútbol Para Todos', links: ['/partidos-de-hoy/', '/rojadirecta/'] },
];
